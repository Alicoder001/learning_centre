...
const teacher_Auth_1 = __importDefault(require("../middleware/teacher.Auth"));
...
teacherRouter.get('/all', adminAuth_1.default, teacher_controller_1.getTeachers);
teacherRouter.get('/total', teacher_Auth_1.default, teacher_controller_1.getTotal);
